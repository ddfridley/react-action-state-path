...
The data for the Articles is retrieved through ArticleStore, which gets it's data from an array, but more normally this data would come from a data base.  These components, __ArticleStore__, __SubArticleList__, and __Article__ are recursively called, the deeper you go. 
